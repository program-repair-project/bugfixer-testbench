...
bic_location = {
    "libtiff": {
        ...
        "2007-08-24-827b6bc-22da1d6": [("tif_dirinfo.c", 333), ("tif_dirinfo.c", 363)],
        "2007-11-02-371336d-865f7b2": [("tif_dirwrite.c", 346)],
        "2008-12-30-362dee5-565eaa2": [("tif_dirwrite.c", 1677), ("thumbnail.c", 164), ("thumbnail.c", 187), ("thumbnail.c", 558), ("thumbnail.c", 599)],
        "2009-02-05-764dbba-2e42d63": [("tiffcrop.c", 2690)],
        "2009-06-30-b44af47-e0b51f3": [("tiffcp.c", 360)],
        "2010-11-27-eb326f9-eec7ec0": [("tiff2pdf.c", 769)],
        "2010-12-13-96a5fb4-bdba15c": [("tiffcrop.c", 1889), ("tiffcrop.c", 4612), ("tiffcrop.c", 4614), ("tiffcrop.c", 4615), ("tiffcrop.c", 4632)]
    }
}
